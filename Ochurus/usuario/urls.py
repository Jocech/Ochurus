...
urlpatterns = [
    ...
    path('reset/password_reset', PasswordResetView.as_view(template_name='recuperacion/password_reset_form.html',
    email_template_name="recuperacion/password_reset_email.html", success_url='password_reset_done'), name = 'password_reset'),
    path('reset/password_reset_done', TemplateView.as_view(template_name='recuperacion/password_reset_done.html'), name = 'password_reset_done'),
    re_path(r'^reset/(?P<uidb64>[0-9A-za-z_\-]+)/(?P<token>.+)/$', PasswordResetConfirmView.as_view(template_name='recuperacion/password_reset_confirm.html'), name = 'password_reset_confirm'),
